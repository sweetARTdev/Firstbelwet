	...
	<div class="content-wrapper">
		...
		<div class="hero-slider-wrapper bg-dark">
			<div class="hero-slider owl-carousel">
				<div class="owl-slide d-flex align-items-center bg-overlay bg-overlay-400" style="background-image: url(img/hero-background.jpg);">
					<div class="container">
						<div class="row">
							<div class="col-md-10 offset-md-1 col-lg-7 offset-lg-0 col-xl-6 col-xxl-5 text-center text-lg-start">
								<h2 class="display-1 fs-56 mb-4 text-white animated-caption" data-anim="animate__slideInDown" data-anim-delay="500">Your shelter of love, healing & comfort!</h2>
								<p class="lead fs-23 lh-sm mb-7 text-white animated-caption" data-anim="animate__slideInRight" data-anim-delay="1000">We are always committed to giving you the best in an exceptional and soothing atmosphere.</p>
								<div class="animated-caption" data-anim="animate__slideInUp" data-anim-delay="1500">
									<a href="#" class="btn btn-md btn-white "> Contact us</a>
								</div>
							</div>
						</div>
					</div>
